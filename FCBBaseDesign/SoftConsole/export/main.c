/*******************************************************************************
 *Microsemi Robotic Arm Demo for Sample Sorting
 *Application code (c) Copyright 2017 Microsemi SoC Products Group & UC Irvine.
      ...
      if ( io_state == 0x00000001 )
      	{
    	    ...
    	    while (1==1) //infinite loop for demo - only stopped by resetting
    	    {
    	    	...
    	    	io_state = GPIO_get_inputs( &g_gpio );
    	    	if (io_state==0x00000002) //stop request received  - demo routine canceled
    	    	{
    	    		//Disable PWM Outputs to halt Servo
